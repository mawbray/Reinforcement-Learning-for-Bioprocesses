...
disc1 = np.array([0.10])                                                                        # discount factor in back-allocation
...
def Plotting(data, bracket, pNo_mean):
    ...
    plt.savefig('D:\\Documents_Data\\UoM\\Projects\\First Year\\RL - Bioprocesses\\WorkBooks\\Reinforcement-Learning-for-Bioprocesses\\Accumulated_reward_' + str(pNo_mean) + 'MC.png')
